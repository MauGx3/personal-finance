...
if PriceHistory:
    ...
    class PriceHistorySerializer(serializers.ModelSerializer):
        ...
        daily_return = serializers.DecimalField(
            max_digits=10, decimal_places=4, read_only=True
        )
...
class AssetPerformanceSerializer(serializers.Serializer):
    ...
    weekly_return = serializers.DecimalField(
        max_digits=10, decimal_places=4, read_only=True
    )
    monthly_return = serializers.DecimalField(
        max_digits=10, decimal_places=4, read_only=True
    )
    ytd_return = serializers.DecimalField(
        max_digits=10, decimal_places=4, read_only=True
    )
    annual_return = serializers.DecimalField(
        max_digits=10, decimal_places=4, read_only=True
    )
    ...
    beta = serializers.DecimalField(
        max_digits=10, decimal_places=4, read_only=True
    )
    sharpe_ratio = serializers.DecimalField(
        max_digits=10, decimal_places=4, read_only=True
    )
    max_drawdown = serializers.DecimalField(
        max_digits=10, decimal_places=4, read_only=True
    )
...
class TechnicalIndicatorsSerializer(serializers.Serializer):
    ...
    # Moving averages
    sma_20 = serializers.DecimalField(
        max_digits=20, decimal_places=8, read_only=True
    )
    sma_50 = serializers.DecimalField(
        max_digits=20, decimal_places=8, read_only=True
    )
    sma_200 = serializers.DecimalField(
        max_digits=20, decimal_places=8, read_only=True
    )
    ema_12 = serializers.DecimalField(
        max_digits=20, decimal_places=8, read_only=True
    )
    ema_26 = serializers.DecimalField(
        max_digits=20, decimal_places=8, read_only=True
    )

    # Oscillators
    rsi_14 = serializers.DecimalField(
        max_digits=5, decimal_places=2, read_only=True
    )
    macd = serializers.DecimalField(
        max_digits=20, decimal_places=8, read_only=True
    )
    macd_signal = serializers.DecimalField(
        max_digits=20, decimal_places=8, read_only=True
    )
    macd_histogram = serializers.DecimalField(
        max_digits=20, decimal_places=8, read_only=True
    )

    # Bollinger Bands
    bb_upper = serializers.DecimalField(
        max_digits=20, decimal_places=8, read_only=True
    )
    bb_middle = serializers.DecimalField(
        max_digits=20, decimal_places=8, read_only=True
    )
    bb_lower = serializers.DecimalField(
        max_digits=20, decimal_places=8, read_only=True
    )
    bb_width = serializers.DecimalField(
        max_digits=10, decimal_places=4, read_only=True
    )

    # Additional indicators
    stochastic_k = serializers.DecimalField(
        max_digits=5, decimal_places=2, read_only=True
    )
    stochastic_d = serializers.DecimalField(
        max_digits=5, decimal_places=2, read_only=True
    )
    williams_r = serializers.DecimalField(
        max_digits=5, decimal_places=2, read_only=True
    )
