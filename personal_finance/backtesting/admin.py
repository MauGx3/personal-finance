...
class StrategyAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (
            "Strategy Parameters",
            {"fields": ("parameters",), "classes": ("collapse",)},
        ),
        (
            "Timestamps",
    ...
    @admin.display(description="Backtests")
    def backtest_count(self, obj):
        """Display number of backtests run for this strategy."""
        count = obj.backtests.count()
        if count > 0:
            url = (
                reverse("admin:backtesting_backtest_changelist")
                + f"?strategy__id__exact={obj.id}"
            )
...
class BacktestAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Basic Information", {"fields": ("strategy", "name", "description")}),
        (
            "Time Period",
    ...
    def strategy_name(self, obj):
        ...
        url = reverse(
            "admin:backtesting_strategy_change", args=[obj.strategy.id]
        )
...
class BacktestResultAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Backtest Information", {"fields": ("backtest",)}),
        (
            "Performance Metrics",
            {
                "fields": (
    ...
    @admin.display(description="Backtest")
    def backtest_name(self, obj):
        """Display backtest name with link."""
        url = reverse(
            "admin:backtesting_backtest_change", args=[obj.backtest.id]
        )
    ...
    @admin.display(description="Annualized Return")
    def annualized_return_display(self, obj):
        ...
        return format_html(
            '<span style="color: {};">{:.2f}%</span>', color, ann_return
        )

    @admin.display(description="Volatility")
    def volatility_display(self, obj):
        ...
        if vol < 10:
            ...
            color = "red"
        return format_html(
            '<span style="color: {};">{:.2f}%</span>', color, vol
        )
    ...
    @admin.display(description="Max Drawdown")
    def max_drawdown_display(self, obj):
        ...
        if dd < 5:
            ...
            color = "red"
        return format_html(
            '<span style="color: {};">{:.2f}%</span>', color, dd
        )
    ...
    def profit_factor_display(self, obj):
        ...
        if pf:
            ...
            if pf_val >= 2.0:
                ...
                color = "red"
            return format_html(
                '<span style="color: {};">{:.2f}</span>', color, pf_val
            )
        return "-"

    @admin.display(description="Expectancy")
    def expectancy_display(self, obj):
        ...
        if exp:
            ...
            return format_html(
                '<span style="color: {};">{:.2f}%</span>', color, exp_val
            )
        return "-"
...
class BacktestPortfolioSnapshotAdmin(admin.ModelAdmin):
    ...
    list_display = [
        ...
        "date",
        "total_value_display",
        "cash_percentage_display",
        "invested_percentage_display",
    ...
    fieldsets = (
        ("Basic Information", {"fields": ("backtest", "date")}),
        (
            "Portfolio Values",
            {
                "fields": (
        ...
        ("Performance", {"fields": ("daily_return", "cumulative_return")}),
        (
            "Benchmark",
            {
        ...
        ("Positions", {"fields": ("positions",), "classes": ("collapse",)}),
    )
    ...
    def cash_percentage_display(self, obj):
        ...
        return format_html(
            '<span style="color: {};">{:.1f}%</span>', color, pct
        )
    ...
    @admin.display(description="Daily Return")
    def daily_return_display(self, obj):
        ...
        if obj.daily_return:
            ...
            return format_html(
                '<span style="color: {};">{:.2f}%</span>', color, ret
            )
        return "-"

    @admin.display(description="Cumulative Return")
...
class BacktestTradeAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (
            "Trade Information",
            {"fields": ("backtest", "asset", "trade_type", "date", "reason")},
        ),
        (
            "Trade Details",
            {
