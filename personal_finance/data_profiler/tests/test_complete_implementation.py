...
class TestProfileDataFunction:
    ...
    def test_profile_data_with_numpy_array(self):
        ...
        assert result['rows'] == 3
        assert result['columns'] == 3
        assert len(result['fields']) >= 0  # Fields may or may not be populated for arrays
    ...
    def test_profile_data_financial_patterns(self):
        ...
        potential_currency = financial_patterns.get('potential_currency_columns', [])
        potential_amounts = financial_patterns.get('potential_amount_columns', [])
...
class TestDataProfilerServiceIntegration:
    ...
    def test_service_initialization(self):
        ...
        service_no_pii = DataProfilerService(enable_sensitive_data_detection=False)
    ...
    @patch('personal_finance.data_profiler.services.DataProfilerService.is_available')
...
def sample_financial_dataframe():
    ...
    return pd.DataFrame({
        ...
        'transaction_type': ['credit', 'debit', 'credit', 'debit', 'debit', 'credit'],
        'account': ['123456789', '123456789', '123456789', '123456789', '123456789', '123456789'],
        'date': ['2023-01-15', '2023-01-16', '2023-01-17', '2023-01-18', '2023-01-19', '2023-01-20'],
        'description': ['Direct deposit', 'ATM withdrawal', 'Transfer from savings', 
                       'Rent payment', 'Grocery store', 'Salary deposit']
    })
...
class TestFixtureBasedScenarios:
    ...
    def test_profile_sensitive_data(self, sample_sensitive_data):
        ...
        result = profile_data(sample_sensitive_data, enable_sensitive_data_detection=True)
