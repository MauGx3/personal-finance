...
class DocumentImport(TimeStampedModel):
    ...
    original_filename = models.CharField(
        max_length=255, help_text="Original filename of uploaded document"
    )
    file_path = models.CharField(
        max_length=500, help_text="Path to stored file"
    )
    ...
    imported_transactions_count = models.IntegerField(
        default=0, help_text="Number of transactions successfully imported"
    )
