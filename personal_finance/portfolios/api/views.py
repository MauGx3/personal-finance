...
class PortfolioViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        ).prefetch_related("positions__asset")
        ...
        try:
            ...
            if group_by == "individual":
                ...
                for position in positions:
                    ...
                    type_groups[asset_type]["unrealized_return"] += (
                    ...
                    allocation_data.append(
                        {
                            ...
                            "asset_name": dict(Asset.ASSET_TYPE_CHOICES).get(
                ...
                for position in positions:
                    ...
                    sector_groups[sector]["unrealized_return"] += (
                        position.unrealized_gain_loss
                    )
...
class PositionViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        return (
            Position.objects.filter(portfolio__user=self.request.user)
...
class TransactionViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        return (
            ...
            .select_related("position__portfolio", "position__asset")
...
class PortfolioSnapshotViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def get_queryset(self):
        ...
        return (
            PortfolioSnapshot.objects.filter(portfolio__user=self.request.user)
