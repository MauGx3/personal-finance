...
class Portfolio(TimestampedModel):
    ...
    name = models.CharField(
        max_length=100, help_text="Display name for the portfolio"
    )
    ...
    is_active = models.BooleanField(
        default=True, help_text="Whether this portfolio is actively tracked"
    )
    ...
    def total_value(self) -> Decimal:
        ...
        return sum(
            ...
            for position in self.positions.filter(is_active=True)
        )
...
class Position(TimestampedModel):
    ...
    is_active = models.BooleanField(
        default=True, help_text="Whether this position is currently held"
    )
    notes = models.TextField(
        blank=True, help_text="Optional notes about this position"
    )
    ...
    def update_from_transactions(self):
        ...
        """
        transactions = self.transactions.order_by(
