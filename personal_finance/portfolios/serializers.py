...
class PortfolioListSerializer(serializers.ModelSerializer):
    ...
    total_return = serializers.DecimalField(
        max_digits=20, decimal_places=2, read_only=True
    )
    total_return_percentage = serializers.DecimalField(
    ...
    def to_representation(self, instance):
        ...
        # Add position count
        data["position_count"] = instance.positions.filter(
            is_active=True
        ).count()
...
class PortfolioSnapshotSerializer(serializers.ModelSerializer):
    ...
    return_percentage = serializers.DecimalField(
        max_digits=10, decimal_places=4, read_only=True
    )
...
class PerformanceMetricsSerializer(serializers.Serializer):
    ...
    annualized_return = serializers.DecimalField(
        max_digits=10, decimal_places=4, read_only=True
    )
    ...
    var_95 = serializers.DecimalField(
        max_digits=10, decimal_places=4, read_only=True
    )
    ...
    alpha = serializers.DecimalField(
        max_digits=10, decimal_places=4, read_only=True
    )
    sortino_ratio = serializers.DecimalField(
        max_digits=10, decimal_places=4, read_only=True
    )
    calmar_ratio = serializers.DecimalField(
        max_digits=10, decimal_places=4, read_only=True
    )
...
class AllocationDataSerializer(serializers.Serializer):
    ...
    unrealized_return = serializers.DecimalField(
