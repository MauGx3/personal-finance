...
router.register(
    r"capital-gains-losses", CapitalGainLossViewSet, basename="capitalgainloss"
)
router.register(
    r"dividend-income", DividendIncomeViewSet, basename="dividendincome"
)
router.register(
    r"loss-harvesting",
    TaxLossHarvestingOpportunityViewSet,
    basename="lossharvesting",
)
router.register(
    r"recommendations",
    TaxOptimizationRecommendationViewSet,
