...
try:  # pragma: no cover - best-effort optional imports
    from . import portfolio  # type: ignore
except Exception:
    portfolio = None  # type: ignore

try:  # pragma: no cover
    from . import yahoo_finance  # type: ignore
except Exception:
...
try:  # pragma: no cover - defensive
    from .logs.logger import logger  # type: ignore
except Exception:
    logger = None  # type: ignore

# Define what gets imported with "from personal_finance import *"
__all__ = ["database", "logger", "portfolio", "yahoo_finance"]
