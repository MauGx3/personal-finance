...
def main():
    ...
    for i, test in enumerate(test_categories, 1):
        ...
        print(f"   {i}. {priority_emoji} {test['name']} - {test['description']}")
    ...
    critical_tests = [t for t in test_categories if t["priority"] == "critical"]
    high_priority_tests = [t for t in test_categories if t["priority"] == "high"]
