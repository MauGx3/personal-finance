...
try:
    from personal_finance.data_sources.enhanced_visualization import (
        enhanced_visualizer,
    )
...
class TestAdvancedAnalytics:
    ...
    @pytest.mark.skipif(
        not ADVANCED_ANALYTICS_AVAILABLE,
        reason="Advanced analytics not available",
    )
    def test_advanced_portfolio_metrics(self, sample_portfolio_data):
        """Test advanced portfolio metrics calculation."""
        metrics = advanced_analyzer.calculate_advanced_metrics(
    ...
    def test_backtesting_strategy_creation(self):
        ...
        strategy = advanced_analyzer.create_backtesting_strategy(
            strategy_config
        )
    ...
    def test_advanced_technical_indicators(self, sample_price_data_with_ohlc):
        ...
        # Create DataFrame
        df = polars_processor.create_price_dataframe(
            sample_price_data_with_ohlc
        )
        ...
        if hasattr(enhanced_df, "columns"):
            ...
            found_indicators = [
                col for col in expected_columns if col in available_columns
            ]
    ...
    def test_portfolio_optimization_metrics(self, sample_portfolio_data):
        ...
        optimization_metrics = (
            polars_processor.calculate_portfolio_optimization_metrics(
        ...
        found_opt_metrics = [
            metric
            for metric in expected_opt_metrics
            if metric in optimization_metrics
        ]
...
class TestEnhancedVisualization:
    ...
    def sample_metrics(self):
        ...
        return {
            ...
            "sector_allocation": {"Technology": 0.8, "Other": 0.2},
            "risk_metrics": {
    ...
    @pytest.mark.skipif(
        not ENHANCED_VISUALIZATION_AVAILABLE,
        reason="Enhanced visualization not available",
    )
    def test_advanced_dashboard_creation(
        self, sample_portfolio_data, sample_metrics
    ):
        """Test advanced portfolio dashboard creation."""
        dashboard_html = (
            enhanced_visualizer.create_advanced_portfolio_dashboard(
        ...
        assert (
            "portfolio" in dashboard_html.lower()
            or "dashboard" in dashboard_html.lower()
        )
    ...
    def test_technical_analysis_chart(self):
        ...
        if chart_html:
            assert (
                "technical" in chart_html.lower()
                or "chart" in chart_html.lower()
            )
    ...
    def test_performance_comparison_chart(self):
        ...
        chart_html = enhanced_visualizer.create_performance_comparison_chart(
            performance_data
        )
        ...
        if chart_html:
            assert (
                "performance" in chart_html.lower()
                or "comparison" in chart_html.lower()
            )
    ...
    def test_risk_return_scatter(self, sample_portfolio_data):
        ...
        if chart_html:
            assert (
                "risk" in chart_html.lower() or "return" in chart_html.lower()
            )
...
class TestIntegrationWorkflows:
    ...
    @pytest.mark.skipif(
        not all(
            [ADVANCED_ANALYTICS_AVAILABLE, ENHANCED_VISUALIZATION_AVAILABLE]
        ),
    ...
    def test_graceful_degradation_all_modules(self):
        ...
        if ADVANCED_ANALYTICS_AVAILABLE:
            empty_metrics = advanced_analyzer.calculate_advanced_metrics(
                empty_portfolio
            )
