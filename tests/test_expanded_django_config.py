...
class TestFormValidation:
    ...
    def test_choice_field_validation(self):
        ...
        expected_types = ['STOCK', 'BOND', 'CRYPTO', 'CASH', 'FUND', 'ETF', 'FOREX', 'FOREIGN_STOCK']
        for expected_type in expected_types:
            assert any(expected_type in choice[0] for choice in Asset.ASSET_TYPE_CHOICES)
...
class TestDatabaseOperations:
    ...
    def test_model_ordering(self):
        ...
        Asset.objects.create(symbol='ZZZZ', name='Z Asset', asset_type=Asset.ASSET_STOCK)
        Asset.objects.create(symbol='AAAA', name='A Asset', asset_type=Asset.ASSET_STOCK)
        Asset.objects.create(symbol='MMMM', name='M Asset', asset_type=Asset.ASSET_STOCK)
...
class TestDevelopmentSettings:
    ...
    def test_email_backend_configuration(self):
        ...
        assert any(dev_backend in backend for dev_backend in development_backends) or \
