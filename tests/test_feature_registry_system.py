...
class TestFeatureRegistry:
    ...
    def test_feature_registry_import(self):
        ...
        from src.personal_finance.feature_registry import FeatureRegistry, registry
    ...
    def test_get_component_with_default(self):
        ...
        result = test_registry.get_component("unknown_feature", "default_value")
    ...
    def test_convenience_functions(self):
        ...
        component = register_optional_feature("unavailable_optional", "nonexistent.module")
...
class TestDjangoFeatureRegistry:
    ...
    def test_django_registry_import(self):
        ...
        from config.django_feature_registry import DjangoFeatureRegistry, django_registry
    ...
    def test_get_viewset_methods(self):
        ...
        result = test_registry.get_viewset("test_feature", "ViewSet1", "default")
    ...
    def test_convenience_functions_django(self):
        ...
        assert get_viewset("test_optional", "TestViewSet", "default") == "default"
...
class TestUpdatedImports:
    ...
    def test_personal_finance_package_imports(self):
        ...
        try:
            ...
            assert pf.yahoo_finance is None or hasattr(pf.yahoo_finance, '__name__')
            ...
            pytest.skip("Personal finance package not properly configured for testing")
            ...
            for viewset_name in viewsets_to_check:
                if hasattr(router_module, viewset_name):
                    ...
                    assert viewset is None or (
                        hasattr(viewset, '__name__') and 'ViewSet' in viewset.__name__
                    )
    ...
    def test_celery_config_imports(self):
        ...
        try:
            ...
            if hasattr(config, 'celery_app'):
                assert config.celery_app is None or hasattr(config.celery_app, 'task')
